...
<script type="text/javascript">
	...
	function callModal(idx, email, nick) {
		...
		$("#modalbody").append(nick+"님의 감정그래프입니다.<br>");
	...
	function click_graph(button, email) {
		...
		var html = '<img src=" '+ '${pageContext.request.contextPath}'+'/assets/graph_image/' + fileName + '.png" onerror="this.src=\''+'${pageContext.request.contextPath}'+'/assets/img/samples/empty_data.jpg\'" >';
				...
				<div class="modal-body" align="center" id="modalbody">
					 <div class="main-box clearfix">
                        ...
                        <div class="btn-group pagination pull-right" style="padding: 10px">
                           ...
                           <button class="btn btn-outline btn-primary btn-xs" value="circle" id="clickpiegraph">pie graph</button>
                        </div>
