               ...
               <li class="dropdown hidden-xs"><a class="btn dropdown-toggle"
                  ...
                  <ul class="dropdown-menu notifications-list messages-list">
                     ...
                     <li class="item first-item"><a href="#"> <img
                           src="${pageContext.request.contextPath}/assets/img/samples/messages-photo-1.png" alt="" /> <span
                     ...
                     <li class="item"><a href="#"> <img
                           src="${pageContext.request.contextPath}/assets/img/samples/messages-photo-2.png" alt="" /> <span
                           class="content"> <span class="content-headline">
                     ...
                     <li class="item"><a href="#"> <img
                           src="${pageContext.request.contextPath}/assets/img/samples/messages-photo-3.png" alt="" /> <span
                           class="content"> <span class="content-headline">
               ...
               <c:when test="${empty authUser }">
                  <li class="dropdown profile-dropdown"><a href="#"
                              class="dropdown-toggle" data-toggle="dropdown"> <img
                                 ...
                                 class="hidden-xs">게스트님 안녕하세요 </li></span> <b class="caret"></b>
                           </a>
               </c:when>
               <c:otherwise>
                  <li class="dropdown profile-dropdown"><a href="#"
