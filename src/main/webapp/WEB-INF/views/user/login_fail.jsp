											...
											<form role="form" method="post" id="loginform">
												...
												<div class="row">
													<div class="col-xs-12 col-sm-6">
														<button class="btn btn-primary col-xs-12 btn-facebook" onclick="clickLogin(this)" value="talker">TALKER로 로그인 </button>
													</div>
													<div class="col-xs-12 col-sm-6">
														<button class="btn btn-primary col-xs-12 btn-twitter" onclick="clickLogin(this)" value="listener"> LISTENER로 로그인
														</button>
													</div>
